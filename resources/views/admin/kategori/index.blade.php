                  ...
                  <div class="panel-heading">
                      <div class="media v-middle">
                        <div class="media-body">
                            <h4 class="text-headline margin-none">Kategori</h4>
                            <p class="text-subhead text-light">Kategori Manajemen</p>
                        </div>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="modal-body">
    <form action="{{ route('kategori.store') }}" method="POST">
      ...
      {!! Form::text('kategori', null, ['placeholder' => 'Nama Kategori','class' => 'form-control', 'required']) !!}
  </div>
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="modal-body">
    <form id="form-updated" method="POST">
      ...
      @method('PUT')
     <label>Nama Kategori</label>
      {!! Form::text('kategori', null, ['placeholder' => 'Nama Kategori','class' => 'form-control', 'id' => 'kategori', 'required']) !!}
...
$(function () {
    ...
    var table = $('#datatables').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('datatables.kategori') }}",
        columns: [
          { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
            { data: 'kategori', name: 'kategori' },
            { data: 'slug_kategori', name: 'slug_kategori' },
